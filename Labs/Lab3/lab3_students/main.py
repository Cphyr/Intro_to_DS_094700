...
def run_kmeans():
    if len(argv) < 5:
        print('Not enough arguments provided. Please provide 4 arguments: K, num_iterations, path_to_input, seed')
        exit(1)
    k = int(argv[1])
    ...
    runner.print_results(random_seed)


if __name__ == '__main__':
    # Expected input: argv[1:] = [K, num_iterations, path_to_input, seed]
    run_kmeans()
